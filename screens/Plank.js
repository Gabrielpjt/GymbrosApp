...
function PlankScreen({ navigation }) {
  ...
  const [targetRep, setTargetRep] = useState(30);
  ...
  if(finished) {
    ...
    return (
      <View style={styles.container}>
        <View style={styles.content}>
          <Image source={require('../assets/Plank.webp')} style={styles.gif} resizeMode="contain" /><Text style={styles.description}>Target Plank Durasi: {targetRep}</Text>
            <Text style={styles.repetisi}>Current Duration: {repetisi}</Text>
            {bpm > (220-age) && (
    ...
    return (
      <View style={styles.container}>
        <View style={styles.content}>
        <Image source={require('../assets/Plank.webp')} style={styles.gif} resizeMode="contain" /><Text style={styles.description}>Target Plank Duration: {targetRep}</Text>
    ...
    return (
      <View style={styles.container}>
        <View style={styles.content}>
          <Image source={require('../assets/Plank.webp')} style={styles.gif} resizeMode="contain" />
          <View>
              <Text style={{textAlign: "center", marginBottom: 12, fontWeight: "bold", fontSize: 24, color: "white"}}>Target Plank Duration </Text>
